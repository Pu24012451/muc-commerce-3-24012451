...
- 学号：24012451
- 专题方向：A
- 已完成功能：1.4张指标卡：总用户数、流失用户、总体流失率、平均订单数
2.2张图表：品类比较柱状图 + 订单趋势折线图
3.品类筛选功能
4.数据表格展示
5.数据观察（生命周期风险洞察）
6.智能问答（5类问题）
7.CSV数据导出
- 选择的拓展任务：A
- 拓展访问或运行方法：1.登录后进入数据看板 2.选择要导出的品类 3.点击"导出CSV"按钮 4.浏览器自动下载CSV文件
- 拓展证据文件：C:\Users\l\Desktop\day07_web_student\day07_web_student\screenshots
- 尚未解决的问题：无
